                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="/process/process_add_services.php" class="user" method="post"
                                        enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="title"
                                                aria-describedby="username" name="title"
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="description"
                                                placeholder="Enter Description of the Service" name="description">
                                            <span class="text-danger">
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <input type="file" class="form-control form-control-user" id="serviceImage"
                                                name="serviceImage">
                                            <span class="text-danger">
                                                <?php
